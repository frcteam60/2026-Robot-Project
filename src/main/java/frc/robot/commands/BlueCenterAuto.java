...
public class BlueCenterAuto extends SequentialCommandGroup {
  /** Creates a new ExampleAuto. */
  public BlueCenterAuto(DriveSubsystem driveSubsystem, Turret turret, Feeder chimney, Intake intake) {
    ...
    new SetPoseAtStartOfAuto(driveSubsystem, BLUE_CENTER_AUTO_START),
  ...
  public void hi() {
      ...
      System.out.println("Feed me fuel");
    }
}
