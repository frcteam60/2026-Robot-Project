...
public class RedRightBumpAuto extends SequentialCommandGroup {
  /** Creates a new ExampleAuto. */
  public RedRightBumpAuto(DriveSubsystem driveSubsystem, Turret turret, Feeder chimney, Intake intake) {
