...
public class RedLeftBumpAuto extends SequentialCommandGroup {
  /** Creates a new ExampleAuto. */
  public RedLeftBumpAuto(DriveSubsystem driveSubsystem, Turret turret, Feeder chimney, Intake intake) {
    ...
    new SetPoseAtStartOfAuto(driveSubsystem, LEFT_RED_BUMP),
